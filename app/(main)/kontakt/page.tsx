          ...
          <div className="flex flex-col gap-10">
            ...
            <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '0.6rem' }}>
                <span style={{ fontFamily: 'var(--font-bebas)', fontSize: 'clamp(2.75rem, 5vw, 3.75rem)', letterSpacing: '0.04em', lineHeight: 1, color: '#c5d000' }}>
                  24
                </span>
              ...
              <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.82rem', lineHeight: 1.7, color: 'var(--text-muted)' }}>
                Dostupni smo svih 24 sata, sedam dana u nedelji, 365 dana u godini —
                bez praznika i bez pauze.
              </p>
            </div>
          </div>
        </div>
