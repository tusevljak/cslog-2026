...
export default function KontaktPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setSending(true)
    // Simulate send — wire up real backend later
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 py-28">
          ...
          <p
            ...
            style={{ fontFamily: 'var(--font-inter)' }}
          >
            Kontaktirajte nas sa bilo kojim pitanjem pisanim putem i mi ćemo vam odgovoriti u najkraćem roku.
          </p>
        </div>
        {/* Hazard tape bottom */}
        <div
          ...
          style={{
            background:
              'repeating-linear-gradient(-45deg, #c5d000 0px, #c5d000 14px, #0d0d0d 14px, #0d0d0d 28px, #ffffff 28px, #ffffff 42px, #0d0d0d 42px, #0d0d0d 56px)',
          }}
        />
      </section>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    placeholder="Opišite vaš zahtev ili postavite pitanje..."
            ...
            <div>
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-1" style={{ fontFamily: 'var(--font-inter)', color: 'var(--text-muted)' }}>
                      Telefon
                    </p>
                    <p className="text-base font-semibold group-hover:text-[#c5d000] transition-colors" style={{ fontFamily: 'var(--font-inter)', color: 'var(--text)' }}>
                      +381 63 209 675
                    </p>
                  </div>
                </a>
            ...
            <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
              ...
              <div className="flex flex-col gap-2" style={{ fontFamily: 'var(--font-inter)' }}>
                <div className="flex justify-between text-sm">
                  <span style={{ color: 'var(--text-muted)' }}>Ponedeljak – Petak</span>
                  <span style={{ color: 'var(--text)' }}>08:00 – 17:00</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span style={{ color: 'var(--text-muted)' }}>Subota</span>
                  <span style={{ color: 'var(--text)' }}>Po dogovoru</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span style={{ color: 'var(--text-muted)' }}>Nedelja</span>
                  <span style={{ color: 'var(--text-muted)' }}>Zatvoreno</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ background: '#c5d000' }}>
        ...
        <div
          ...
          style={{
            background:
              'repeating-linear-gradient(-45deg, #0d0d0d 0px, #0d0d0d 14px, #c5d000 14px, #c5d000 28px, #ffffff 28px, #ffffff 42px, #c5d000 42px, #c5d000 56px)',
          }}
        />
        <div className="max-w-[1280px] mx-auto px-6 py-16 flex flex-col items-center text-center gap-6">
          ...
          <div>
            <p className="font-semibold text-[#0d0d0d] text-lg italic" style={{ fontFamily: 'Georgia, serif' }}>
              Boban Bićanin
            </p>
            <p className="text-[#0d0d0d]/60 text-xs uppercase tracking-widest mt-1" style={{ fontFamily: 'var(--font-inter)' }}>
              Generalni direktor
            </p>
          </div>
        </div>
