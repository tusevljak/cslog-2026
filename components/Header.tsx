...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50" style={{ background: 'var(--bg)' }}>
      ...
      {/* ── MAIN HEADER ROW — logo spans full height, right side has two tiers ── */}
      <div style={{ borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'stretch' }}
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          <div className="hidden lg:flex items-center justify-between h-14" style={{ padding: '0 2rem' }}>
            ...
            <a
              href="#upit"
              className="inline-flex items-center gap-2 font-bold uppercase tracking-widest text-xs px-5 py-2 transition-all duration-200"
